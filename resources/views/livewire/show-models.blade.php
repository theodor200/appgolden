                        ...
                        @foreach($models_devices as $model)
                            <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                                <dt>
                                    ...
                                    <p class="ml-16 text-sm font-medium text-gray-500 truncate">{{$model['value']}}
                                        <br><b>{{ucwords($model['type'])}}  {{ucwords($model['color'])}}</b>
                                    </p>
                                </dt>
                                <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                                    ...
                                    <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
                                        <div class="text-sm">
                                            <a href="{{ route('devices', ['model'=>$model['value'] == '' ? 'all' : $model['value'], 'customer'=>$this->getId() ]) }}" class="font-medium text-indigo-600 hover:text-indigo-500 mr-3">
                                                Dispositivos
                                            </a>
                                            <a href="{{ route('suministros', ['type'=>$model['type'],'color'=>$model['color'], 'model'=>$model['value'],'customer'=>$this->getId() ]) }}" target="_blank" class="font-medium text-indigo-600 hover:text-indigo-500 mr-3">
                                                Suministros
                                            </a>
