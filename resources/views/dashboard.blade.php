<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-center bg-white overflow-hidden shadow-xl sm:rounded-lg py-40">
                <!--<x-jet-welcome />-->
                <svg class="h-20 w-20 text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p class="text-gray-300 text-2xl py-4">Aplicativo en desarrollo</p>
            </div>
        </div>
    </div>
</x-app-layout>
